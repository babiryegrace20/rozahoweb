...
?>
   <body>
    ...
    <section class="hero-wrap hero-wrap-2" style="background-image: url('images/DSC_0192.png');height:100vh;" data-stellar-background-ratio="0.5">
		...
		<!--<section class="ftco-section">
          ...
          <div class="col-md-4 ftco-animate">
            <div class="blog-entry">
              <a href="blog-single.php" class="block-20" style="background-image: url('images/image_1.png');">
              </a>
          ...
          <div class="col-md-4 ftco-animate">
            <div class="blog-entry">
              <a href="blog-single.php" class="block-20" style="background-image: url('images/image_2.png');">
              </a>
              <div class="text pt-3 pb-4">
                <div class="meta">
                  <div><a href="#">June 25, 2019</a></div>
          ...
          <div class="col-md-4 ftco-animate">
            <div class="blog-entry">
              <a href="blog-single.php" class="block-20" style="background-image: url('images/image_3.png');">
              </a>
              <div class="text pt-3 pb-4">
                <div class="meta">
                  <div><a href="#">June 25, 2019</a></div>
          ...
          <div class="col-md-4 ftco-animate">
            <div class="blog-entry">
              <a href="blog-single.php" class="block-20" style="background-image: url('images/image_4.png');">
              </a>
              <div class="text pt-3 pb-4">
                <div class="meta">
                  <div><a href="#">June 25, 2019</a></div>
          ...
          <div class="col-md-4 ftco-animate">
            <div class="blog-entry">
              <a href="blog-single.php" class="block-20" style="background-image: url('images/image_5.png');">
              </a>
              <div class="text pt-3 pb-4">
                <div class="meta">
                  <div><a href="#">June 25, 2019</a></div>
          ...
          <div class="col-md-4 ftco-animate">
            <div class="blog-entry">
              <a href="blog-single.php" class="block-20" style="background-image: url('images/image_6.png');">
              </a>
              <div class="text pt-3 pb-4">
                <div class="meta">
                  <div><a href="#">June 25, 2019</a></div>
