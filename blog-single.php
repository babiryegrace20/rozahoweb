...
?>
   <body>
    ...
    <section class="hero-wrap hero-wrap-2" style="background-image: url('images/bg_3.png');" data-stellar-background-ratio="0.5">
    ...
    <section class="ftco-section">
          ...
          <div class="col-lg-8 ftco-animate">
            ...
            <div class="about-author d-flex p-4 bg-light">
              <div class="bio mr-5">
                <img src="images/person_1.png" alt="Image placeholder" class="img-fluid mb-4">
              </div>
              <div class="desc">
          ...
          <div class="col-lg-4 sidebar ftco-animate">
            ...
            <div class="sidebar-box ftco-animate">
              ...
              <div class="block-21 mb-4 d-flex">
                <a class="blog-img mr-4" style="background-image: url(images/image_1.png);"></a>
                <div class="text">
